...
export default function LandingPage() {
  return (
    <>
      <Navbar />
      <div className="flex flex-col sm:justify-evenly justify-between lg:mt-0 mt-10 min-h-screen">
        <div className="flex sm:justify-center md:justify-center lg:gap-0 md:gap-4 lg:pl-24 lg:justify-start sm:pt-24 sm:mt-6 w-full">
          ...
          >
            ...
            <motion.h1
              ...
              className="text-white  font-serif pt-11 pb-9 text-5xl md:text-6xl lg:text-7xl font-light leading-tight md:leading-13 mb-4 sm:mb-10 md:mb-8 text-center md:text-left"
            >
            ...
            <motion.p
              ...
              className="text-white  font-bold text-yellow-200 text-2xl md:text-xl mb-6 sm:mb-12 md:mb-8 text-center md:text-left"
            >
            ...
            <motion.div
              ...
              className="flex justify-center md:justify-start sm:pt-12"
            >
