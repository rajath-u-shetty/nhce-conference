      ...
      <div className="container mx-auto">
        <div className="flex justify-between items-center">
          ...
          <div className="hidden lg:flex items-center space-x-4 ml-auto">
            ...
            <Link href="/speakers" className="hover:text-blue-200">Speakers</Link>
            <Link href="/program" className="hover:text-blue-200">Program</Link>
            <Link href="/registration" className="hover:text-blue-200">Registration</Link>
            <Link href="/accommodation" className="hover:text-blue-200">Accommodation</Link>
        ...
        {isOpen && (
          <div className="lg:hidden mt-4 space-y-2">
            ...
            <Link href="/speakers" className="block hover:text-blue-200">Speakers</Link>
            <Link href="/program" className="block hover:text-blue-200">Program</Link>
            <Link href="/registration" className="block hover:text-blue-200">Registration</Link>
            <Link href="/accommodation" className="block hover:text-blue-200">Accommodation</Link>
            <Link href="/gallery" className="block hover:text-blue-200">Gallery</Link>
